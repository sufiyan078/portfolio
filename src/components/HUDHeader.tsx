        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-wrap items-center gap-2 font-pixel text-[8px] text-gray-400 mt-1">
              ...
              <div className="inline-flex items-center gap-1">
                <span className="leading-none">LEVEL 99</span>
                <span className="text-[#FF8F00] text-[6px] inline-flex items-center">
                  LVL
                  <div className="inline-flex flex-col items-center -space-y-[2px] shrink-0">
                    <svg className="w-[6px] h-[6px] fill-[#08CB00] animate-pulse" viewBox="0 0 24 24">
