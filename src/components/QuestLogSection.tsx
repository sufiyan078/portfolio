    ...
    <section id="quest-log" className="py-24 px-4 max-w-7xl mx-auto relative font-sans">
      ...
      <div className="flex flex-col items-center text-center mb-16">
        <div className="badge-tag border border-[#FF8F00]/40 bg-[#FF8F00]/10 text-[#FF8F00] mb-3 group">
          <Flag className="w-3.5 h-3.5 text-[#FF8F00] transition-transform duration-300 group-hover:scale-110" />
                ...
                <div>
                  <div className="flex flex-wrap items-center gap-3 mb-2">
                    ...
                    {quest.status === 'IN PROGRESS' ? (
                      <span className="font-mono text-[10px] text-[#10B981] font-bold px-2.5 py-0.5 rounded-md bg-[#10B981]/15 border border-[#10B981]/40 flex items-center gap-1.5">
