...
// Custom animated Bot icon matching Screenshot 2 (retro robot head, antenna signal, eye blink, levitation)
const AnimatedBotIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg className={`fill-none stroke-current ${className}`} viewBox="0 0 24 24" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
    <style>{`
    ...
    <g className="bot-head-bob">
      {/* Top Antenna Stem & Pulsing Signal Bulb */}
      <path d="M12 7V4" />
      ...
      {/* Animated Robot Eyes (Arch shapes matching Screenshot 2) */}
